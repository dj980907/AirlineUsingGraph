...
//this class is the vertex class
//in this case, vertex is a city
//city has name and code and connected city
class City{
...
public class AirlineGraph{
	...
	void connectCity(String code1, String code2) {
		...
		if(c1 == null || c2 == null) {
			System.out.println("Cannot connect those cities, Invalid city code...");
			return;
		}
	...
	public static void main(String[] args) {
		...
		//add vertex (in this case city) in the graph
		g.addCity("SFO", "San Francisco");
